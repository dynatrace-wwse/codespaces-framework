...
| Job ID | `enablement-16f553efb405` |
| Pages crawled | 13 |
| Steps executed | 44 |
| Pass | 1 |
| Fail | **3** |
...
**Error:** sh: 1: validate:: not found
sh: 2: needs:: not found
sh: 3: outputs:: not found
...
sh: 3: applyMonacoConfig: not found
sh: 6: monaco: not found
