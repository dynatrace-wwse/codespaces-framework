...
| Job ID | `enablement-7e39671d8280` |
| Pages crawled | 10 |
| Steps executed | 129 |
| Pass | 6 |
| Fail | **4** |
...
**Error:** --2026-05-25 23:22:14--  http://%3Cyour-url-here%3E/
Resolving <your-url-here> (<your-url-here>)... failed: Name or service not known.
wget: unable to resolve host address '<your-url-here>'
...
**Error:** sh: 2: ansible-playbook: not found
